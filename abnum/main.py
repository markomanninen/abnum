...
class Abnum(object):
    ...
    def value(self, string):
        ...
        """
        return self.unicode_value(unicode(string, encoding="utf-8"))
    ...
    def char_table_data(self, text, modulo = 9):
        ...
        for word in text.decode('utf-8').split():
            ...
            for idx, letter in enumerate(word):
                ...
                data['transliteration'].append(self.convert(letter.encode('utf-8')))
                data['value'].append(self.value(letter.encode('utf-8')))
    ...
    def char_table(self, text, modulo = 9):
        ...
        for word in text.split():
            ...
            for letter in word:
                ...
                tr2 += h.td(self.convert(letter.encode('utf-8')))
